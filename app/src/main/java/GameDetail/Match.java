...
public class Match implements Serializable {
    ...
    @Expose
    private List<Opponent_> opponents = null;
    ...
    public Winner_ getWinner() {
        return winner;
    }

    public void setWinner(Winner_ winner) {
        this.winner = winner;
    }
    ...
    public List<Opponent_> getOpponents() {
        return opponents;
    }

    public void setOpponents(List<Opponent_> opponents) {
    ...
    public void setGames(List<Game_> games) {
        this.games = games;
    }
